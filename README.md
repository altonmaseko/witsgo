...
This is the backend of our WitsGo application. It manages and servers all the databases that our application uses. The various data that the backend manages includes:
